...
#define TOP_CLASS VAdderWrapper
...
#endif
#if VM_COVERAGE
  VerilatedCov::write("/home/teemo/Chisel_Projects/blackbox_example/test_run_dir/DUT_should_pass/coverage.dat");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = "/home/teemo/Chisel_Projects/blackbox_example/test_run_dir/DUT_should_pass/AdderWrapper.";
